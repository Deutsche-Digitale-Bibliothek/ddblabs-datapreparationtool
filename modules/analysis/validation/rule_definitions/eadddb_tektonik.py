def compile_validation_rules() -> dict:
    ...
    value_list_langcode = ['aar', 'abk', 'ace', 'ach', 'ada', 'ady', 'afa', 'afh', 'afr', 'aka', 'akk', 'alb', 'ale',
                           'alg', 'amh', 'ang', 'apa', 'ara', 'arc', 'arg', 'arm', 'arn', 'arp', 'art', 'arw', 'asm',
                           'ast', 'ath', 'aus', 'ava', 'ave', 'awa', 'aym', 'aze', 'bad', 'bai', 'bak', 'bal', 'bam',
                           'ban', 'baq', 'bas', 'bat', 'bej', 'bel', 'bem', 'ben', 'ber', 'bho', 'bih', 'bik', 'bin',
                           'bis', 'bla', 'bnt', 'bod', 'bos', 'bra', 'bre', 'btk', 'bua', 'bug', 'bul', 'bur', 'bur',
                           'byn', 'cad', 'cai', 'car', 'cat', 'cau', 'ceb', 'cel', 'ces', 'cha', 'chb', 'che', 'chg',
                           'chi', 'chk', 'chm', 'chn', 'cho', 'chp', 'chr', 'chu', 'chv', 'chy', 'cmc', 'cop', 'cor',
                           'cos', 'cpe', 'cpf', 'cpp', 'cre', 'crh', 'crp', 'csb', 'cus', 'cym', 'cze', 'cze', 'dak',
                           'dan', 'dar', 'day', 'del', 'den', 'deu', 'dgr', 'din', 'div', 'doi', 'dra', 'dsb', 'dua',
                           'dum', 'dut', 'dut', 'dyu', 'dzo', 'efi', 'egy', 'eka', 'ell', 'elx', 'eng', 'enm', 'epo',
                           'est', 'eus', 'eus', 'ewe', 'ewo', 'fan', 'fao', 'fas', 'fat', 'fij', 'fil', 'fin', 'fiu',
                           'fon', 'fra', 'fre', 'frm', 'fro', 'fry', 'ful', 'fur', 'gaa', 'gay', 'gba', 'gem', 'geo',
                           'ger', 'gez', 'gil', 'gla', 'gle', 'glg', 'glv', 'gmh', 'goh', 'gon', 'gor', 'got', 'grb',
                           'grc', 'gre', 'gre', 'grn', 'guj', 'gwi', 'hai', 'hat', 'hau', 'haw', 'heb', 'her', 'hil',
                           'him', 'hin', 'hit', 'hmn', 'hmo', 'hrv', 'hsb', 'hun', 'hup', 'hye', 'iba', 'ibo', 'ice',
                           'ice', 'ido', 'iii', 'ijo', 'iku', 'ile', 'ilo', 'ina', 'inc', 'ind', 'ine', 'inh', 'ipk',
                           'ira', 'iro', 'isl', 'ita', 'jav', 'jbo', 'jpn', 'jpr', 'jrb', 'kaa', 'kab', 'kac', 'kal',
                           'kam', 'kan', 'kar', 'kas', 'kat', 'kau', 'kaw', 'kaz', 'kbd', 'kha', 'khi', 'khm', 'kho',
                           'kik', 'kin', 'kir', 'kmb', 'kok', 'kom', 'kon', 'kor', 'kos', 'kpe', 'krc', 'kro', 'kru',
                           'kua', 'kum', 'kur', 'kut', 'lad', 'lah', 'lam', 'lao', 'lat', 'lav', 'lez', 'lim', 'lin',
                           'lit', 'lol', 'loz', 'ltz', 'lua', 'lub', 'lug', 'lui', 'lun', 'luo', 'lus', 'mac', 'mad',
                           'mag', 'mah', 'mai', 'mak', 'mal', 'man', 'mao', 'mao', 'map', 'mar', 'mas', 'may', 'mdf',
                           'mdr', 'men', 'mga', 'mic', 'min', 'mis', 'mkd', 'mkh', 'mlg', 'mlt', 'mnc', 'mni', 'mno',
                           'moh', 'mol', 'mon', 'mos', 'mri', 'msa', 'mul', 'mun', 'mus', 'mwl', 'mwr', 'mya', 'myn',
                           'myv', 'nah', 'nai', 'nap', 'nau', 'nav', 'nbl', 'nde', 'ndo', 'nds', 'nep', 'new', 'nia',
                           'nic', 'niu', 'nld', 'nno', 'nob', 'nog', 'non', 'nor', 'nso', 'nub', 'nwc', 'nya', 'nym',
                           'nyn', 'nyo', 'nzi', 'oci', 'oji', 'ori', 'orm', 'osa', 'oss', 'ota', 'oto', 'paa', 'pag',
                           'pal', 'pam', 'pan', 'pap', 'pau', 'peo', 'per', 'phi', 'phn', 'pli', 'pol', 'pon', 'por',
                           'pra', 'pro', 'pus', 'que', 'raj', 'rap', 'rar', 'roa', 'roh', 'rom', 'ron', 'rum', 'run',
                           'rus', 'sad', 'sag', 'sah', 'sai', 'sal', 'sam', 'san', 'sas', 'sat', 'scc', 'scn', 'sco',
                           'scr', 'sel', 'sem', 'sga', 'sgn', 'shn', 'sid', 'sin', 'sio', 'sit', 'sla', 'slk', 'slo',
                           'slv', 'sma', 'sme', 'smi', 'smj', 'smn', 'smo', 'sms', 'sna', 'snd', 'snk', 'sog', 'som',
                           'son', 'sot', 'spa', 'sqi', 'srd', 'srp', 'srr', 'ssa', 'ssw', 'suk', 'sun', 'sus', 'sux',
                           'swa', 'swe', 'syr', 'tah', 'tai', 'tam', 'tat', 'tel', 'tem', 'ter', 'tet', 'tgk', 'tgl',
                           'tha', 'tib', 'tib', 'tig', 'tir', 'tiv', 'tkl', 'tlh', 'tli', 'tmh', 'tog', 'ton', 'tpi',
                           'tsi', 'tsn', 'tso', 'tuk', 'tum', 'tup', 'tur', 'tut', 'tvl', 'twi', 'tyv', 'udm', 'uga',
                           'uig', 'ukr', 'umb', 'und', 'urd', 'uzb', 'vai', 'ven', 'vie', 'vol', 'vot', 'wak', 'wal',
                           'war', 'was', 'wel', 'wen', 'wln', 'wol', 'xal', 'xho', 'yao', 'yap', 'yid', 'yor', 'ypk',
                           'zap', 'zen', 'zha', 'zho', 'znd', 'zul', 'zun']
    value_list_scriptcode = ['Arab', 'Armn', 'Bali', 'Batk', 'Beng', 'Blis', 'Bopo', 'Brah', 'Brai', 'Bugi', 'Buhd',
                             'Cans', 'Cham', 'Cher', 'Cirt', 'Copt', 'Cprt', 'Cyrl', 'Cyrs', 'Deva', 'Dsrt', 'Egyd',
                             'Egyh', 'Egyp', 'Ethi', 'Geok', 'Geor', 'Glag', 'Goth', 'Grek', 'Gujr', 'Guru', 'Hang',
                             'Hani', 'Hano', 'Hans', 'Hant', 'Hebr', 'Hira', 'Hmng', 'Hrkt', 'Hung', 'Inds', 'Ital',
                             'Java', 'Kali', 'Kana', 'Khar', 'Khmr', 'Knda', 'Laoo', 'Latf', 'Latg', 'Latn', 'Lepc',
                             'Limb', 'Lina', 'Linb', 'Mand', 'Maya', 'Mero', 'Mlym', 'Mong', 'Mymr', 'Nkoo', 'Ogam',
                             'Orkh', 'Orya', 'Osma', 'Perm', 'Phag', 'Phnx', 'Plrd', 'Qaaa', 'Qabx', 'Roro', 'Runr',
                             'Sara', 'Shaw', 'Sinh', 'Sylo', 'Syrc', 'Syre', 'Syrj', 'Syrn', 'Tagb', 'Tale', 'Talu',
                             'Taml', 'Telu', 'Teng', 'Tfng', 'Tglg', 'Thaa', 'Thai', 'Tibt', 'Ugar', 'Vaii', 'Visp',
                             'Xpeo', 'Xsux', 'Yiii', 'Zxxx', 'Zyyy', 'Zzzz']
    value_list_physdesc_genreform = ["Urkunden", "Siegel", "Amtsbücher, Register und Grundbücher", "Akten",
                                     "Karten und Pläne", "Plakate und Flugblätter", "Drucksachen", "Bilder",
                                     "Handschriften", "Audio-Visuelle Medien", "Datenbanken", "Sonstiges"]
    value_list_mediatype_genreform = ["TEXT", "AUDIO", "BILD", "VOLLTEXT", "SONSTIGES", "OHNE MEDIENTYP"]
    value_list_federal_states = ["Baden-Württemberg", "Bayern", "Berlin", "Brandenburg", "Bremen", "Hamburg", "Hessen", "Mecklenburg-Vorpommern", "Niedersachsen", "Nordrhein-Westfalen", "Rheinland-Pfalz", "Saarland", "Sachsen", "Sachsen-Anhalt", "Schleswig-Holstein", "Thüringen"]
    ...
    #     {"attribute_name": "{http://www.w3.org/2001/XMLSchema-instance}schemaLocation", "allowed_values": [
    #         "urn:isbn:1-931666-22-9 http://www.loc.gov/ead/ead.xsd http://www.w3.org/1999/xlink http://www.loc.gov/standards/xlink/xlink.xsd"],
    #      "allowed_patterns": []})
    ruleset["attribute_def"].append(
    ...
    ruleset["element_children_optional"] = False
    ruleset["optional_attributes"] = []
    ruleset["obligatory_attributes"] = ["countryencoding", "dateencoding", "langencoding", "repositoryencoding",
                                        "scriptencoding"]
    ruleset["optional_subelements"] = []
    ruleset["obligatory_subelements"] = ["{urn:isbn:1-931666-22-9}eadid", "{urn:isbn:1-931666-22-9}filedesc",
                                         "{urn:isbn:1-931666-22-9}profiledesc"]
    ruleset["max_occurence"] = 1
    ruleset["text_character_content_allowed"] = False
    ruleset["tail_character_content_allowed"] = False
    ...
    ruleset["rule_conditions"].append(
        {"text_values": [],
         "attribute_def": [],
         "reference_elements": [
             {"element_name": "{urn:isbn:1-931666-22-9}profiledesc", "attribute_def": [], "preceding_elements": 2}]})
    ...
    ruleset["attribute_def"].append(
        {"attribute_name": "level", "allowed_values": ["collection"],
         "allowed_patterns": []})
    ruleset["attribute_def"].append(
        {"attribute_name": "type", "allowed_values": ["Tektonik", "tektonik"],
         "allowed_patterns": []})
    ...
    ruleset["element_children_optional"] = True
    ruleset["optional_attributes"] = []
    ruleset["obligatory_attributes"] = ["label"]
    ruleset["optional_subelements"] = ["{urn:isbn:1-931666-22-9}corpname"]
    ruleset["obligatory_subelements"] = []
    ruleset["max_occurence"] = 1
    ruleset["text_character_content_allowed"] = False
    ruleset["tail_character_content_allowed"] = False
    ...
    ruleset["attribute_def"] = []
    ruleset["attribute_def"].append(
        {"attribute_name": "label", "allowed_values": value_list_federal_states,
         "allowed_patterns": []})
    ...
    ruleset["attribute_def"] = []
    ruleset["attribute_def"].append(
        {"attribute_name": "role", "allowed_values": ["Übergeordnete Institution"],
         "allowed_patterns": []})
    ...
    ruleset["rule_conditions"].append(
        {"text_values": [],
         "attribute_def": [],
         "reference_elements": [
             {"element_name": "{urn:isbn:1-931666-22-9}archdesc", "attribute_def": [], "preceding_elements": 3}]})
    ...
    ruleset["optional_subelements"] = ["{urn:isbn:1-931666-22-9}userestrict", "{urn:isbn:1-931666-22-9}otherfindaid", "{urn:isbn:1-931666-22-9}c"]
    ...
    # /ead/archdesc/dsc/c[@level="collection"]/did
    ruleset = {}
    ...
    ruleset["obligatory_attributes"] = []
    ruleset["optional_subelements"] = []
    ruleset["obligatory_subelements"] = ["{urn:isbn:1-931666-22-9}repository", "{urn:isbn:1-931666-22-9}unittitle"]
    ruleset["max_occurence"] = 1
    ruleset["text_character_content_allowed"] = False
    ruleset["tail_character_content_allowed"] = False
    ...
    # /ead/archdesc/dsc/c[@level="collection"]/did/repository
    ruleset = {}
    ...
    ruleset["optional_attributes"] = []
    ruleset["obligatory_attributes"] = []
    ruleset["optional_subelements"] = ["{urn:isbn:1-931666-22-9}address", "{urn:isbn:1-931666-22-9}extref"]
    ruleset["obligatory_subelements"] = ["{urn:isbn:1-931666-22-9}corpname"]
    ruleset["max_occurence"] = 1
    ruleset["text_character_content_allowed"] = False
    ruleset["tail_character_content_allowed"] = False
    ...
    ruleset["rule_conditions"].append(
        {"text_values": [],
         "attribute_def": [],
         "reference_elements": [
             {"element_name": "{urn:isbn:1-931666-22-9}c", "attribute_def": [{"attribute_name": "level", "allowed_values": ["collection"]}], "preceding_elements": 2}]})

    rulesets_repository.append(ruleset)
    validation_rules["{urn:isbn:1-931666-22-9}repository"] = rulesets_repository

    # /ead/archdesc/dsc/c[@level="collection"]/did/unittitle
    rulesets_unittitle = []
    ruleset = {}
    ...
    # /ead/archdesc/dsc/c[@level="collection"]/did/repository/corpname
    ruleset = {}
    ...
    ruleset["attribute_def"] = []
    ruleset["attribute_def"].append(
        {"attribute_name": "role", "allowed_values": ["Aggregator", "Staatliche Archive", "Kommunale Archive", "Kirchliche Archive", "Herrschafts- und Familienarchive", "Wirtschaftsarchive", "Archive der Parlamente, politischen Parteien, Stiftungen und Verbände", "Medienarchive", "Archive der Hochschulen sowie wissenschaftlicher Institutionen", "Sonstige"],
         "allowed_patterns": []})
    ruleset["attribute_def"].append(
        {"attribute_name": "id",
         "allowed_values": [],
    ...
    ruleset["rule_conditions"].append(
        {"text_values": [],
         "attribute_def": [],
         "reference_elements": [
             {"element_name": "{urn:isbn:1-931666-22-9}c", "attribute_def": [{"attribute_name": "level", "allowed_values": ["collection"]}], "preceding_elements": 3}]})

    rulesets_corpname.append(ruleset)
    validation_rules["{urn:isbn:1-931666-22-9}corpname"] = rulesets_corpname

    # /ead/archdesc/dsc/c[@level="collection"]/did/repository/address
    rulesets_address = []
    ruleset = {}
    ...
    # ead/archdesc/dsc/c[@level="collection"]/did/repository/address/addressline
    ...
    # ead/archdesc/dsc/c[@level="collection"]/did/repository/extref
    rulesets_extref = []
    ruleset = {}
    ...
    # ead/archdesc/dsc/c[@level="collection"]/userestrict
    ...
    # ead/archdesc/dsc/c[@level="collection"]/userestrict/head; ead/archdesc/dsc//c/userestrict/head
    rulesets_head = []
    ruleset = {}
    ...
    # ead/archdesc/dsc/c[@level="collection"]/userestrict/p; ead/archdesc/dsc//c/userestrict/p
    rulesets_p = []
    ruleset = {}
    ...
    # ead/archdesc/dsc/c[@level="collection"]/userestrict[@type]/p
    ruleset = {}
    ...
    ruleset["rule_conditions"].append(
        {"text_values": [],
         "attribute_def": [],
         "reference_elements": [
             {"element_name": "{urn:isbn:1-931666-22-9}userestrict",
              "attribute_def": [{"attribute_name": "type", "allowed_values": ["ead", "dao"]}],
    ...
    # /ead/archdesc/dsc/c[@level="collection"]/userestrict[@type]/p/extref
    ruleset = {}
    ...
    # /ead/archdesc/dsc/c[@level="collection"]/otherfindaid
    ...
    # /ead/archdesc/dsc/c[@level="collection"]/otherfindaid/extref
    ruleset = {}
    ...
    ruleset["attribute_def"].append(
        {"attribute_name": "{http://www.w3.org/1999/xlink}href", "allowed_values": [],
         "allowed_patterns": [pattern_uri]})
    ruleset["attribute_def"].append(
        {"attribute_name": "{http://www.w3.org/1999/xlink}role", "allowed_values": ["url_tektonik"],
         "allowed_patterns": []})
    ...
    ruleset["optional_attributes"] = []
    ruleset["obligatory_attributes"] = ["level", "id"]
    ruleset["optional_subelements"] = ["{urn:isbn:1-931666-22-9}scopecontent",
                                       "{urn:isbn:1-931666-22-9}relatedmaterial",
                                       "{urn:isbn:1-931666-22-9}accessrestrict", "{urn:isbn:1-931666-22-9}odd",
                                       "{urn:isbn:1-931666-22-9}index", "{urn:isbn:1-931666-22-9}c", "{urn:isbn:1-931666-22-9}otherfindaid"]
    ruleset["obligatory_subelements"] = ["{urn:isbn:1-931666-22-9}did"]
    ruleset["max_occurence"] = None
    ruleset["text_character_content_allowed"] = False
    ruleset["tail_character_content_allowed"] = False
    ...
    ruleset["attribute_def"] = []
    ruleset["attribute_def"].append(
        {"attribute_name": "level", "allowed_values": ["file"],
         "allowed_patterns": []})
    ruleset["attribute_def"].append(
        {"attribute_name": "id", "allowed_values": [],
         "allowed_patterns": [pattern_xs_token_simple]})
    ...
    ruleset["rule_conditions"].append(
        {"text_values": [],
         "attribute_def": [{"attribute_name": "level", "allowed_values": ["file"]}],
         "reference_elements": []})

    rulesets_c.append(ruleset)
    validation_rules["{urn:isbn:1-931666-22-9}c"] = rulesets_c

    # /ead/archdesc/dsc///c[@level="class|series"]
    ruleset = {}
    ...
    ruleset["optional_attributes"] = []
    ruleset["obligatory_attributes"] = []
    ruleset["optional_subelements"] = ["{urn:isbn:1-931666-22-9}unitid", "{urn:isbn:1-931666-22-9}abstract",
                                       "{urn:isbn:1-931666-22-9}unitdate", "{urn:isbn:1-931666-22-9}physdesc",
                                       "{urn:isbn:1-931666-22-9}materialspec", "{urn:isbn:1-931666-22-9}langmaterial",
                                       "{urn:isbn:1-931666-22-9}note", "{urn:isbn:1-931666-22-9}origination"]
    ...
    # /ead/archdesc/dsc//c[@level="file"]/scopecontent
    ...
    # /ead/archdesc/dsc//c[@level="file"]/relatedmaterial
    ...
    ruleset["rule_conditions"].append(
        {"text_values": [],
         "attribute_def": [],
         "reference_elements": [
             {"element_name": "{urn:isbn:1-931666-22-9}relatedmaterial", "attribute_def": [],
              "preceding_elements": 1}]})
    ...
    # /ead/archdesc/dsc//c[@level="class|series"]/userestrict
    ruleset = {}
    ...
    ruleset["optional_attributes"] = []
    ruleset["obligatory_attributes"] = []
    ruleset["optional_subelements"] = ["{urn:isbn:1-931666-22-9}lb", "{urn:isbn:1-931666-22-9}date",
                                       "{urn:isbn:1-931666-22-9}emph"]
    ruleset["obligatory_subelements"] = []
    ruleset["max_occurence"] = 1
    ruleset["text_character_content_allowed"] = True
    ruleset["tail_character_content_allowed"] = False
    ...
    ruleset["optional_attributes"] = []
    ruleset["obligatory_attributes"] = []
    ruleset["optional_subelements"] = ["{urn:isbn:1-931666-22-9}geogname", "{urn:isbn:1-931666-22-9}subject",
                                       "{urn:isbn:1-931666-22-9}persname", "{urn:isbn:1-931666-22-9}corpname"]
    ruleset["obligatory_subelements"] = []
    ruleset["max_occurence"] = None
    ruleset["text_character_content_allowed"] = False
    ruleset["tail_character_content_allowed"] = False
    ...
    ruleset["rule_conditions"].append(
        {"text_values": [],
         ...
         "reference_elements": [
             {"element_name": "{urn:isbn:1-931666-22-9}c",
              "attribute_def": [{"attribute_name": "level", "allowed_values": ["class", "series", "file"]}],
              "preceding_elements": 1}]})

    rulesets_otherfindaid.append(ruleset)
    validation_rules["{urn:isbn:1-931666-22-9}otherfindaid"] = rulesets_otherfindaid

    # /ead/archdesc/dsc//c[@level="class|series"]/otherfindaid/extref
    ruleset = {}
    ...
    # /ead/archdesc/dsc//c[@level="file"]/otherfindaid/extref
    ruleset = {}
    ...
    ruleset["attribute_def"].append(
        {"attribute_name": "{http://www.w3.org/1999/xlink}href", "allowed_values": [],
         "allowed_patterns": [pattern_uri]})
    ruleset["attribute_def"].append(
        {"attribute_name": "{http://www.w3.org/1999/xlink}role", "allowed_values": ["url_bestand"],
         "allowed_patterns": []})
